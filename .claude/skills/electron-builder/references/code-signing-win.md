...
If you are using an EV Certificate, you need to provide [win.certificateSubjectName](/win#WindowsConfiguration-certificateSubjectName) in your electron-builder configuration.
...
If you are on Linux or Mac and you want sign a Windows app using EV Code Signing Certificate, please use [the guide for Unix systems](/tutorials/code-signing-windows-apps-on-unix).
