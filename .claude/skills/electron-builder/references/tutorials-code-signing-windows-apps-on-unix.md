...
Described setup and configuration is required only if you have EV code signing certificate. The regular certificates supported [out of the box](/code-signing#windows).
...
6. Run `osslsigncode` with the correct module, engine and key id
