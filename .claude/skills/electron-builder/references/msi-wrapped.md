# https://www.electron.build/msi-wrapped

# MSI Wrapped

## Configuration

[Electron-Builder](/packages) / [app-builder-lib](/app-builder-lib/) / MsiWrappedOptions
...
> `readonly` `optional` **wrappedInstallerArgs**: `null` | `string`
