...
* Linux:
  + if you build on Windows or macOS: [Snap](/snap) and [AppImage](/appimage) for x64.
  + if you build on Linux: [Snap](/snap) and [AppImage](/appimage) for current architecture.
