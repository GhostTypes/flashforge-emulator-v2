# https://www.electron.build/contents

# Application Contents

## File Contents

[Electron-Builder](/packages) / [app-builder-lib](/app-builder-lib/) / FilesBuildOptions
...
[Electron-Builder](/packages) / [app-builder-lib](/app-builder-lib/) / FileSet
...
The [glob patterns](/file-patterns). Defaults to “\**/*“
...
* the [app directory](/configuration#directories) for `files`,
