...
#### Styling based on the descendants of a group (group-has-'})
...
#### Styling based on the descendants of a peer (peer-has-'})
...
| print | @media print |
| supports-[&hellip;] | @supports (&hellip;) |
| aria-checked | &[aria-checked="true"] |
| aria-disabled | &[aria-disabled="true"] |
| aria-expanded | &[aria-expanded="true"] |
| aria-hidden | &[aria-hidden="true"] |
